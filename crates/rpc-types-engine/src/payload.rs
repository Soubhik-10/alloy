        ...
        let input = r#"
{
    ...
    fn serde_payload_input_enum_v4() {
        ...
        let payload_v4: ExecutionPayloadV4 = serde_json::from_str(response_v4).unwrap();
        assert_eq!(payload.as_v4().unwrap(), &payload_v4);
    }

    #[test]
    #[cfg(feature = "serde")]
    fn serde_faulty_roundtrip_payload_input_v4() {
        let response_v4 = r#"{"parentHash":"0x9a3ac13c3bf8a1fcf72cf6cf42bc22518682e20468cbbce75884a3f88854f732","feeRecipient":"0x584377bce64b7cd8e9828e8b0d1f95acbaf2c7c2","stateRoot":"0x22578ef689f2e401e1dbbe75e975c5eb877156eb15cf8cc3c49a7a57427ebc11","receiptsRoot":"0xf78dfb743fbd92ade140711c8bbc542b5e307f0ab7984eff35d751969fe57efa","logsBloom":"","prevRandao":"0x44a3dc58ab78fe363d1e213811daef0caba59a4284f4a050cda6abdb4e967425","blockNumber":"0x1","gasLimit":"0x1380d","gasUsed":"0x5208","timestamp":"0x68b78f4b","extraData":"0x726574682f76312e362e302f6c696e7578","baseFeePerGas":"0x341565c00","blockHash":"0xd462ad353b8d5b42fc7dce75d6a3823784037641bd6e06a0e2647df0e6d254d9","transactions":["0x02f876820a28808477359400847735940082520894ab0840c0e43688012c1adb0f5e3fc665188f83d28a029d394a5d630544000080c080a0a044076b7e67b5deecc63f61a8d7913fab86ca365b344b5759d1fe3563b4c39ea019eab979dd000da04dfc72bb0377c092d30fd9e1cab5ae487de49586cc8b0090"],"withdrawals":[],"blobGasUsed":"0x0","excessBlobGas":"0x0","blockAccessList":"0xf854eb946be02d1d3665660d22ff9624b7be0551ee1ac91bc0c0cecd018b4a454687d9c55ec4a76000c3c20101c0e794ab0840c0e43688012c1adb0f5e3fc665188f83d2c0c0cdcc018a029d394a5d6305440000c0c0"}"#;

        let payload: ExecutionPayloadV3 = serde_json::from_str(response_v4).unwrap();
        assert_ne!(response_v4, serde_json::to_string(&payload).unwrap());
    }
